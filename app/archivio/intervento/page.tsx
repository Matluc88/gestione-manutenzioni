...
export default function ArchivioIntervento() {
  ...
  const handleFiltriChange = (newFiltri: typeof filtri) => {
    setFiltri({ ...newFiltri, tipo: 'INTERVENTO' });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Archivio Intervento Tecnico</h1>
